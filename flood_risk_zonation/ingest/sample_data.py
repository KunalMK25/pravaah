...
DEMO_REGIONS: dict[str, DemoRegion] = {
    ...
    "Indian Hilly Region": DemoRegion(
        name="Indian Hilly Region (Sikkim Foothills)",
        bbox=BoundingBox(min_lon=87.50, min_lat=27.40, max_lon=88.57, max_lat=28.47),
        base_elevation_m=1200.0,
        relief_m=500.0,
        mean_rainfall_mm=2500.0,
        seed=29,
    ),
    "Nepal Flood Area": DemoRegion(
        name="Nepal Recent Flood-Affected Area (Rasuwa District)",
        bbox=BoundingBox(min_lon=85.40, min_lat=28.10, max_lon=86.47, max_lat=29.17),
        base_elevation_m=1500.0,
        relief_m=800.0,
        mean_rainfall_mm=1800.0,
        seed=31,
    ),
    "Indian Ocean": DemoRegion(
        name="Indian Ocean Open Water (Arabian Sea)",
        bbox=BoundingBox(min_lon=71.50, min_lat=9.50, max_lon=72.57, max_lat=10.57),
        base_elevation_m=0.0,
        relief_m=0.0,
        mean_rainfall_mm=500.0,
        seed=37,
    ),
}
